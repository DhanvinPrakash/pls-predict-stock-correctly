...
bashgit clone https://github.com/your-username/imbusy-dbs-advisor.git
cd imbusy-dbs-advisor
...
6. Build and run
Select your Mac as the target and hit Run. The app will fetch live DBS data on launch and display a Buy / Hold / Sell verdict immediately.
...
Export as a Developer ID signed application
The recipient must have macOS 26, Apple Silicon, and Apple Intelligence enabled
The .mlmodel is bundled inside the .app — no separate installation needed
